...
dt=$(date +'%Y%m%d %H:%M')
echo "$dt"
mount /dev/sdb1 /media/pi/usb/ && \
rsync -aEvx --delete-after --exclude-from=/home/pi/scripts/backup-exclude.cnf / /media/pi/usb/pi_backup/ #--log-file=/home/pi/scripts/log/backup_sh.log && \
umount /dev/sdb1
RESULT_BACKUP=$?
